...
console.log("Titlecase:", Namecases[0].toUpperCase() + Namecases.substring(1).toLowerCase());
...
const FamousQuote = "Albert Einstein";
const author = "A person who never made a mistake never tried anything new.";
console.log(`${FamousQuote} once said ${author}`);
...
const Famous_Quote = "Albert Einstein";
const quote = "A person who never made a mistake never tried anything new.";
const printmessage = `${Famous_Quote}  once said," ${quote}`;
...
const personname = ["Ayaan", "Rayaan", "Asma", "Muslim"];
...
const names = ["Ayaan", "Rayaan", "Asma", "Muslim"];
const message = "Do you like to play Game?";
...
//Initial guest list
let guestList = ["Ayaan", "Rayaan", "Aslam",];
for (let i = 0; i < guestList.length; i++) {
    console.log('Dear Mr.' + guestList[i] + ',It is our pleasure to you in our party.Thank You!\n');
}
let absentGuest = 'Ayaan';
let newGuest = 'Shayan';
...
const citiesInPakistan = ["Karachi", "Lahore", "Islamabad", "Rawalpindi",];
...
const person = { name: "Ayaan", gender: "Male", age: 30 };
console.log(person);
...
let name_1 = "Asma";
let name_2 = "Asma Muslim";
let name_3 = "Miss Asma Muslim";
// if(name_1 == name_3){
...
let adminnames = ["admin", "asma", "ayaan", "rayaan", "sana"];
for (let username of adminnames) {
    if (username === "admin") {
