...
const FamousQuote: string = "Albert Einstein";
const author: string = "A person who never made a mistake never tried anything new."
...
const Famous_Quote: string = "Albert Einstein";
const quote: string = "A person who never made a mistake never tried anything new.";
const printmessage: string = `${Famous_Quote}  once said," ${quote}`;
...
const personname: string[] = ["Ayaan", "Rayaan", "Asma", "Muslim"];
...
let adminnames: string [] = ["admin", "asma", "ayaan", "rayaan", "sana"];
